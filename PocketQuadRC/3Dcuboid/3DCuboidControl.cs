...
namespace ArPilot.Labs._3Dcuboid
{
    public partial class _3DCuboidControl : UserControl
    {
        ...
        public double[] RotationMatrix
        {
            get
            {
                return new double[] {transformationMatrix[0], transformationMatrix[4], transformationMatrix[8],
            ...
            set
            {
                ...
                transformationMatrix[0] = (float)value[0]; transformationMatrix[4] = (float)value[1]; transformationMatrix[8] = (float)value[2];
                transformationMatrix[1] = (float)value[3]; transformationMatrix[5] = (float)value[4]; transformationMatrix[9] = (float)value[5];
                transformationMatrix[2] = (float)value[6]; transformationMatrix[6] = (float)value[7]; transformationMatrix[10] = (float)value[8];
            }
        }
        ...
        /// </param>
        public _3DCuboidControl(string[] imageFilePaths)
        ...
        /// </param>
        public _3DCuboidControl(string[] imageFilePaths, float[] dimensions)
        ...
        /// </param>
        public _3DCuboidControl(string[] imageFilePaths, float[] dimensions, CameraViews cameraView)
        ...
        /// Value describing the camera view of the cuboid.
        /// </param>
        public _3DCuboidControl(string[] imageFilePaths, CameraViews cameraView)
        ...
        /// </param>
        public _3DCuboidControl(string[] imageFilePaths, CameraViews cameraView, float cameraDistance)
        ...
        /// Distance of the camera from the world origin.
        /// </param>
        public _3DCuboidControl(string[] imageFilePaths, float cameraDistance)
        ...
        /// Dimensions of the cuboid.
        /// </param>
        public _3DCuboidControl(float[] dimensions)
        ...
        /// Value describing the camera view of the cuboid.
        /// </param>
        public _3DCuboidControl(float[] dimensions, CameraViews cameraView)
        ...
        /// Distance of the camera from the world origin.
        /// </param>
        public _3DCuboidControl(float[] dimensions, CameraViews cameraView, float cameraDistance)
        ...
        /// Distance of the camera from the world origin.
        /// </param>
        public _3DCuboidControl(float[] dimensions, float cameraDistance)
        ...
        /// Value describing the camera view of the cuboid.
        /// </param>
        public _3DCuboidControl(CameraViews cameraView)
        ...
        /// Distance of the camera from the world origin.
        /// </param>
        public _3DCuboidControl(CameraViews cameraView, float cameraDistance)
        ...
        /// Distance of the camera from the world origin.
        /// </param>
        public _3DCuboidControl(float cameraDistance)
        ...
        /// Distance of the camera from the world origin.
        /// </param>
        public _3DCuboidControl(string[] imageFilePaths, float[] dimensions, CameraViews cameraView, float cameraDistance)
        {
            if (!designMode)
            {
        ...
        private uint[] LoadTextureFromImage(string[] filesNames)
        {
            ...
            {
                var fname = @"3Dcuboid\Textures\" + filesNames[im];
                if (File.Exists(fname))
                {
                    bitmap[im] = new Bitmap(fname);
                }
            }
